  ...
  {
      static_assert(
          (std::is_same<typename make_unsigned<T>::type, U>::value), "");
      static_assert((std::is_same<make_unsigned_t<T>, U>::value), "");
  }
  ...
  main()
  {
      ...
      test_make_unsigned<wchar_t,
          std::conditional<sizeof(wchar_t) == 4, unsigned int, unsigned short>::
              type>();
      test_make_unsigned<const wchar_t,
          std::conditional<sizeof(wchar_t) == 4,
              const unsigned int,
      ...
      test_make_unsigned<BigEnum,
          std::conditional<sizeof(long) == 4, unsigned long long, unsigned long>::
              type>();
  }
