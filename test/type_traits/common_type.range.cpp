...
{
	STATIC_REQUIRE(std::is_same<common_reference_t<B&, D&>, B&>::value);
	STATIC_REQUIRE(
	...
	STATIC_REQUIRE(std::is_same<common_reference_t<B&, D&, B&, D&>, B&>::value);
	...
	STATIC_REQUIRE(std::is_same<common_reference_t<B&, D&&>, B const&>::value);
	STATIC_REQUIRE(
		std::is_same<common_reference_t<B&, D const&&>, B const&>::value);
	STATIC_REQUIRE(
		std::is_same<common_reference_t<B const&, D&&>, B const&>::value);
	...
	STATIC_REQUIRE(std::is_same<common_reference_t<int, short>, int>::value);
	STATIC_REQUIRE(std::is_same<common_reference_t<int, short&>, int>::value);
	STATIC_REQUIRE(std::is_same<common_reference_t<int&, short&>, int>::value);
	STATIC_REQUIRE(std::is_same<common_reference_t<int&, short>, int>::value);
	...
	// Array types?? Yup!
	STATIC_REQUIRE(std::is_same<common_reference_t<int(&)[10], int(&&)[10]>,
		int const(&)[10]>::value);
	...
	STATIC_REQUIRE(std::is_same<
		...
		common_pair<int const&, int const&>>::value);


	// BUGBUG TODO Is a workaround possible?
#if !defined(__GNUC__) || __GNUC__ != 4 || __GNUC_MINOR__ > 8
	STATIC_REQUIRE(
		std::is_same<common_reference_t<common_pair<int const&, int const&>,
						 std::pair<int, int>>,
			std::pair<int, int>>::value);


	STATIC_REQUIRE(
		std::is_same<detail::_builtin_common_t<common_pair<int, int> const&,
						 std::pair<int, int>&>,
	...
	STATIC_REQUIRE(
		std::is_same<detail::_builtin_common_t<noncopyable const&, noncopyable>,
			noncopyable>::value);


	STATIC_REQUIRE(
		std::is_same<detail::_builtin_common_t<noncopyable2 const&, noncopyable>,
			noncopyable>::value);


	STATIC_REQUIRE(
		std::is_same<detail::_builtin_common_t<noncopyable const&, noncopyable2>,
			noncopyable>::value);
}
