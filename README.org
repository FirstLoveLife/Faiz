...
- [[https://github.com/Morwenn/tight_pair/][tight_pair]](~compressed_pair.hpp~, for [[https://en.cppreference.com/w/cpp/language/ebo][ebco]] and test cases), [[https://github.com/ericniebler/range-v3][range-v3]](for utilities like is_swappable and some meta functions), and
...
[[https://github.com/taocpp/operators][- tao-operators]](for compare functions, can be replaced with ~three-way
comparison~ if it is available.). Each of these software components have their own license. Please see ./Foo/License.txt, ./Bar/License.txt, and ./Whatsit/License.txt.
