...
{
    empty_POD_UDT& operator=(const empty_POD_UDT&)
    {
        return *this;
    }
...
struct compressed_pair_tester
{
    ...
    typedef typename rider::faiz::call_traits<first_type>::param_type first_param_type;
    typedef typename rider::faiz::call_traits<second_type>::param_type second_param_type;
    // define our test proc:
    static void test(first_param_type p1, second_param_type p2, first_param_type p3, second_param_type p4);
};

template<class T1, class T2>
void compressed_pair_tester<T1, T2>::test(
    first_param_type p1, second_param_type p2, first_param_type p3, second_param_type p4)
{
#ifndef __GNUC__
...
#endif
    // default construct:
    rider::faiz ::compressed_pair<T1, T2> cp1;
    // first param construct:
    rider::faiz::compressed_pair<T1, T2> cp2(p1);
    cp2.second() = p2;
    BOOST_TEST(cp2.first() == p1);
    BOOST_TEST(cp2.second() == p2);
    // second param construct:
    rider::faiz ::compressed_pair<T1, T2> cp3(p2);
    cp3.first() = p1;
    BOOST_TEST(cp3.second() == p2);
    BOOST_TEST(cp3.first() == p1);
    // both param construct:
    rider::faiz ::compressed_pair<T1, T2> cp4(p1, p2);
    BOOST_TEST(cp4.first() == p1);
    BOOST_TEST(cp4.second() == p2);
    rider::faiz ::compressed_pair<T1, T2> cp5(p3, p4);
    BOOST_TEST(cp5.first() == p3);
    BOOST_TEST(cp5.second() == p4);
    // check const members:
    const rider::faiz ::compressed_pair<T1, T2>& cpr1 = cp4;
    BOOST_TEST(cpr1.first() == p1);
    BOOST_TEST(cpr1.second() == p2);

    // copy construct:
    rider::faiz ::compressed_pair<T1, T2> cp6(cp4);
...
template<class T1, class T2>
void compressed_pair_reference_tester<T1, T2>::test(
    first_param_type p1, second_param_type p2, first_param_type p3, second_param_type p4)
{
#ifndef __GNUC__
    // gcc 2.90 can't cope with function scope using
...
template<class T1, class T2>
void compressed_pair_reference1_tester<T1, T2>::test(
    first_param_type p1, second_param_type p2, first_param_type, second_param_type)
{
...
template<class T1, class T2>
void compressed_pair_reference2_tester<T1, T2>::test(
    first_param_type p1, second_param_type p2, first_param_type, second_param_type)
{
#ifndef BOOST_NO_TEMPLATE_PARTIAL_SPECIALIZATION
    // second param construct:
...
template<class T1, class T2>
void compressed_pair_array1_tester<T1, T2>::test(
    first_param_type p1, second_param_type p2, first_param_type, second_param_type)
{
    // default construct:
    rider::faiz ::compressed_pair<T1, T2> cp1;
    ...
    // check const members:
    const rider::faiz::compressed_pair<T1, T2>& cpr1 = cp3;
...
template<class T1, class T2>
void compressed_pair_array2_tester<T1, T2>::test(
    first_param_type p1, second_param_type p2, first_param_type, second_param_type)
{
    // default construct:
    rider::faiz::compressed_pair<T1, T2> cp1;
    ...
    // check const members:
    const rider::faiz::compressed_pair<T1, T2>& cpr1 = cp2;
    BOOST_TEST(cpr1.first() == p1);
...
template<class T1, class T2>
void compressed_pair_array_tester<T1, T2>::test(
    first_param_type p1, second_param_type p2, first_param_type, second_param_type)
{
    // default construct:
    rider::faiz::compressed_pair<T1, T2> cp1;
    ...
    // check const members:
    const rider::faiz::compressed_pair<T1, T2>& cpr1 = cp1;
    BOOST_TEST(cpr1.first()[0] == p1[0]);
    BOOST_TEST(cpr1.second()[0] == p2[0]);
