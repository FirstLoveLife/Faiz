...
namespace ranges
{
	inline namespace v3
	{
		...
		template<typename Rng>
		using safe_iterator_t = meta::if_<std::is_lvalue_reference<Rng>,
		...
		template<typename Rng>
		using range_difference_t RANGES_DEPRECATED(
		...
		template<typename Rng>
		using range_iterator RANGES_DEPRECATED("range_iterator is deprecated")
			= meta::defer<iterator_t, Rng>;

		template<typename Rng>
		using range_sentinel RANGES_DEPRECATED("range_sentinel is deprecated")
			= meta::defer<sentinel_t, Rng>;

		template<typename Rng>
		using range_category RANGES_DEPRECATED("range_category is deprecated")
			= meta::defer<range_category_t, Rng>;

		template<typename Rng>
		using range_value RANGES_DEPRECATED("range_value is deprecated")
		...
		template<typename Rng>
		using range_reference RANGES_DEPRECATED("range_reference is deprecated")
		...
		template<typename Rng>
		using range_size RANGES_DEPRECATED("range_size is deprecated")
		...
		namespace detail
		{
			...
			std::integral_constant<cardinality, Card>
