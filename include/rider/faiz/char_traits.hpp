...
namespace rider::faiz
{
    ...
    template<class CharT>
    constexpr int char_traits<CharT>::compare(
    ...
    template<class CharT>
    constexpr size_t char_traits<CharT>::length(const char_type* s)
    {
        size_t len = 0;
    ...
    constexpr int char_traits<char>::compare(
    ...
    constexpr const char* char_traits<char>::find(
    ...
    constexpr int char_traits<wchar_t>::compare(
        const char_type* s1, const char_type* s2, size_t n) noexcept
    {
        if (n == 0)
            return 0;
    ...
    constexpr size_t char_traits<wchar_t>::length(const char_type* s) noexcept
    {
        size_t len = 0;
        for (; !eq(*s, char_type(0)); ++s)
            ++len;
    ...
    constexpr const wchar_t* char_traits<wchar_t>::find(
        const char_type* s, size_t n, const char_type& a) noexcept
    {
        if (n == 0)
            return nullptr;
    ...
    constexpr int char_traits<char16_t>::compare(
        const char_type* s1, const char_type* s2, size_t n) noexcept
    {
        for (; n; --n, ++s1, ++s2)
        {
    ...
    constexpr size_t char_traits<char16_t>::length(const char_type* s) noexcept
    {
        size_t len = 0;
        for (; !eq(*s, char_type(0)); ++s)
            ++len;
    ...
    constexpr const char16_t* char_traits<char16_t>::find(
        const char_type* s, size_t n, const char_type& a) noexcept
    {
        for (; n; --n)
        {
    ...
    inline char16_t* char_traits<char16_t>::copy(
        char_type* s1, const char_type* s2, size_t n) noexcept
    {
        faiz::Debug::assertWithLog(
            s2 < s1 || s2 >= s1 + n, "char_traits::copy overlapped range");
    ...
    constexpr int char_traits<char32_t>::compare(
        const char_type* s1, const char_type* s2, size_t n) noexcept
    {
        for (; n; --n, ++s1, ++s2)
        {
    ...
    constexpr size_t char_traits<char32_t>::length(const char_type* s) noexcept
    {
        size_t len = 0;
        for (; !eq(*s, char_type(0)); ++s)
            ++len;
    ...
    constexpr const char32_t* char_traits<char32_t>::find(
        const char_type* s, size_t n, const char_type& a) noexcept
    {
        for (; n; --n)
        {
    ...
    inline char32_t* char_traits<char32_t>::move(
        char_type* s1, const char_type* s2, size_t n) noexcept
    {
        char_type* r = s1;
        if (s1 < s2)
    ...
    inline char32_t* char_traits<char32_t>::copy(
        char_type* s1, const char_type* s2, size_t n) noexcept
    {
        faiz::Debug::assertWithLog(
            s2 < s1 || s2 >= s1 + n, "char_traits::copy overlapped range");
